 ...
 */
package it.jaschke.alexandria.barcodeDetection.camera;
...
public class GraphicOverlay<T extends GraphicOverlay.Graphic> extends View {
    ...
    protected void onDraw(Canvas canvas) {
        ...
        synchronized (mLock) {
            ...
            if(mFirstGraphic != null){
                mFoundBookButton.setVisibility(VISIBLE);
                mFirstGraphic.draw(canvas);
            }else{
                mFoundBookButton.setVisibility(INVISIBLE);
            }
...
//            }
    ...
    public void setFoundButton(View view){
        mFoundBookButton = view;
    }
}
